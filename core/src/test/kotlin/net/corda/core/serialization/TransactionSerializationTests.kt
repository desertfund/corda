...
class TransactionSerializationTests {
    ...
    val megaCorpServices = MockServices(setOf("net.corda.core.serialization"), MEGA_CORP.name, MEGA_CORP_KEY)
    val notaryServices = MockServices(setOf("net.corda.core.serialization"), DUMMY_NOTARY.name, DUMMY_NOTARY_KEY)
